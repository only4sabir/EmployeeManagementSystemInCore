...
namespace EMS_New.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var bloggingContext = _context.Employee.Include(e => e.Department);
        ...
        {
            //ViewData["DepartmentId"] = new SelectList(_context.Department, "Name", "DepartmentId");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,Name,Address,Mobile,DepartmentId")] Employee employee)
        {
